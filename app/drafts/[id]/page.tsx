  ...
  return (
    <main className="space-y-5">
      <section className="panel px-6 py-5">
        <p className="text-xs uppercase tracking-[0.25em] text-sky-700">草稿工作区</p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 lg:grid-cols-3">
              {supportContext.supportingSignals.map((signal) => (
                <div className="rounded-2xl border border-slate-300/60 bg-stone-50/80 px-4 py-4" key={signal.id}>
      ...
      {editorialAngle ? (
        <section className="panel px-6 py-5">
          <div className="space-y-3">
            ...
            <p className="text-sm leading-6 text-slate-700">{editorialAngle.guidance}</p>
          </div>
        </section>
      ) : null}
